...
function [harris_keypoints] = harris_keypoint_detector(ScaleSpace,varargin)
global options
...
sigma = ScaleSpace.initial_sigma; %Sigma for scale space
num_scales = ScaleSpace.num_scales;
