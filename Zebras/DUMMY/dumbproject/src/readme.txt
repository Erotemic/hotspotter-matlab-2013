...
================================
-run_dumbproject.sh (shell script run to temporarily set environment variables and 
 execute the application)
   -to run the shell script, type
   
       ./run_dumbproject.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2010a/v713, run the shell script as:
       ...
       ./run_dumbproject.sh /mathworks/home/application/R2010a/v713
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_dumbproject.sh /mathworks/devel/application/matlab
-MCRInstaller.dmg 
   -include when building component by selecting "include MCR" option 
    in deploytool
-The Macintosh bundle directory structure dumbproject.app 
   -this can be gathered up using the zip command 
    zip -r dumbproject.zip dumbproject.app
    or the tar command 
    tar -cvf dumbproject.tar dumbproject.app
-This readme file 
    ...
    Mac                     DYLD_LIBRARY_PATH
     ...
     ii. Set the path by doing one of the following:
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_dumbproject.sh 
