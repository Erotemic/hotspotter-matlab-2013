...
function [matches, scores]  = get_match_harris(i, j, f1, f2, d1, d2 ,varargin)
...
neighbors_to_search1 = query_property(i,-1,'largest_keypoint_cluster')+1;
neighbors_to_search2 = query_property(j,-1,'largest_keypoint_cluster')+1;
