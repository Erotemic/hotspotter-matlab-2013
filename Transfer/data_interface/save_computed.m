function [] = save_computed(i_index, computed,varargin)
global StoredData
global config

%TODO remove i_index from args
i_index = computed.img_id;
...
if StoredData.isKey(i_index) | save_in_memory == 1
  StoredData(i_index) = computed;
else
